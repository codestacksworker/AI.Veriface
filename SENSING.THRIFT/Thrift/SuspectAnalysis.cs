...
[Serializable]
#endif
public partial class SuspectAnalysis : TBase
{
  ...
  public void Write(TProtocol oprot) {
    ...
    try
    {
      TStruct struc = new TStruct("SuspectAnalysis");
      ...
      if (Capimg != null && __isset.capimg) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (CapCount _iter31 in Capimg)
          {
            _iter31.Write(oprot);
          }
          oprot.WriteListEnd();
  ...
  public override string ToString() {
    StringBuilder __sb = new StringBuilder("SuspectAnalysis(");
    bool __first = true;
    if (TcChannelID != null && __isset.tcChannelID) {
