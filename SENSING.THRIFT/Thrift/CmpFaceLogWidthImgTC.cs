...
[Serializable]
#endif
public partial class CmpFaceLogWidthImgTC : TBase
{
  private string _ID;
  ...
  public void Write(TProtocol oprot) {
    ...
    try
    {
      TStruct struc = new TStruct("CmpFaceLogWidthImgTC");
      ...
      if (Timg != null && __isset.timg) {
        field.Name = "timg";
        field.Type = TType.String;
        field.ID = 10;
        oprot.WriteFieldBegin(field);
        oprot.WriteBinary(Timg);
        oprot.WriteFieldEnd();
      }
  ...
  public override string ToString() {
    StringBuilder __sb = new StringBuilder("CmpFaceLogWidthImgTC(");
    bool __first = true;
    if (ID != null && __isset.ID) {
