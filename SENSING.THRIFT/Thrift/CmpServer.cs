...
public partial class CmpServer {
  public interface Iface {
    ...
    #endif
    List<CmpResultMulti> CompareMulti(List<FeaInfo> fealist, int nThreshold, int nMaxCount);
    #if SILVERLIGHT
    IAsyncResult Begin_CompareMulti(AsyncCallback callback, object state, List<FeaInfo> fealist, int nThreshold, int nMaxCount);
    List<CmpResultMulti> End_CompareMulti(IAsyncResult asyncResult);
    #endif
  }
  ...
  public class Client : IDisposable, Iface {
    ...
    #if SILVERLIGHT
    public IAsyncResult Begin_CompareMulti(AsyncCallback callback, object state, List<FeaInfo> fealist, int nThreshold, int nMaxCount)
    {
      return send_CompareMulti(callback, state, fealist, nThreshold, nMaxCount);
    }

    public List<CmpResultMulti> End_CompareMulti(IAsyncResult asyncResult)
    {
      oprot_.Transport.EndFlush(asyncResult);
      return recv_CompareMulti();
    }

    #endif

    public List<CmpResultMulti> CompareMulti(List<FeaInfo> fealist, int nThreshold, int nMaxCount)
    {
      #if !SILVERLIGHT
      send_CompareMulti(fealist, nThreshold, nMaxCount);
      return recv_CompareMulti();

      #else
      var asyncResult = Begin_CompareMulti(null, null, fealist, nThreshold, nMaxCount);
      return End_CompareMulti(asyncResult);

      #endif
    }
    #if SILVERLIGHT
    public IAsyncResult send_CompareMulti(AsyncCallback callback, object state, List<FeaInfo> fealist, int nThreshold, int nMaxCount)
    #else
    public void send_CompareMulti(List<FeaInfo> fealist, int nThreshold, int nMaxCount)
    #endif
    {
      oprot_.WriteMessageBegin(new TMessage("CompareMulti", TMessageType.Call, seqid_));
      CompareMulti_args args = new CompareMulti_args();
    ...
    public List<CmpResultMulti> recv_CompareMulti()
    {
      TMessage msg = iprot_.ReadMessageBegin();
      if (msg.Type == TMessageType.Exception) {
        TApplicationException x = TApplicationException.Read(iprot_);
      ...
      CompareMulti_result result = new CompareMulti_result();
      result.Read(iprot_);
      iprot_.ReadMessageEnd();
      if (result.__isset.success) {
        return result.Success;
      }
      throw new TApplicationException(TApplicationException.ExceptionType.MissingResult, "CompareMulti failed: unknown result");
    }
  ...
  public class Processor : TProcessor {
    public Processor(Iface iface)
    {
      ...
      processMap_["CompareMulti"] = CompareMulti_Process;
    }
    ...
    public void CompareMulti_Process(int seqid, TProtocol iprot, TProtocol oprot)
    {
      CompareMulti_args args = new CompareMulti_args();
      args.Read(iprot);
      iprot.ReadMessageEnd();
      CompareMulti_result result = new CompareMulti_result();
      result.Success = iface_.CompareMulti(args.Fealist, args.NThreshold, args.NMaxCount);
      oprot.WriteMessageBegin(new TMessage("CompareMulti", TMessageType.Reply, seqid)); 
      result.Write(oprot);
      oprot.WriteMessageEnd();
      oprot.Transport.Flush();
    }
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            oprot.WriteFieldBegin(field);
            {
              ...
              foreach (CmpResult _iter115 in Success)
              {
      ...
      try
      {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
              foreach (CmpResult _iter119 in Success)
              {
      ...
      try
      {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
              foreach (FaceInfo _iter123 in Success)
              {
      ...
      try
      {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
              foreach (FaceInfo _iter127 in Success)
              {
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    CompareImgResult _elem134;
                    _elem134 = new CompareImgResult();
                    _elem134.Read(iprot);
      ...
      try
      {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
              foreach (CompareImgResult _iter135 in Success)
              {
  ...
  [Serializable]
  #endif
  public partial class CompareMulti_args : TBase
  {
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    FeaInfo _elem138;
                    _elem138 = new FeaInfo();
                    _elem138.Read(iprot);
                    Fealist.Add(_elem138);
                  }
                  iprot.ReadListEnd();
                }
              } else { 
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("CompareMulti_args");
        oprot.WriteStructBegin(struc);
        TField field = new TField();
        if (Fealist != null && __isset.fealist) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (FeaInfo _iter139 in Fealist)
            {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("CompareMulti_args(");
      bool __first = true;
      if (Fealist != null && __isset.fealist) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
  ...
  [Serializable]
  #endif
  public partial class CompareMulti_result : TBase
  {
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    CmpResultMulti _elem142;
                    _elem142 = new CmpResultMulti();
                    _elem142.Read(iprot);
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("CompareMulti_result");
        oprot.WriteStructBegin(struc);
        TField field = new TField();
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
              foreach (CmpResultMulti _iter143 in Success)
              {
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("CompareMulti_result(");
      bool __first = true;
      if (Success != null && __isset.success) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
