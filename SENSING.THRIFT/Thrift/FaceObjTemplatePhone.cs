...
[Serializable]
#endif
public partial class FaceObjTemplatePhone : TBase
{
  ...
  public void Write(TProtocol oprot) {
    ...
    try
    {
      TStruct struc = new TStruct("FaceObjTemplatePhone");
  ...
  public override string ToString() {
    StringBuilder __sb = new StringBuilder("FaceObjTemplatePhone(");
    bool __first = true;
    if (TcUuid != null && __isset.tcUuid) {
