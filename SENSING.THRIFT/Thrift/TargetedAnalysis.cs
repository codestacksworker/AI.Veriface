...
[Serializable]
#endif
public partial class TargetedAnalysis : TBase
{
  ...
  public void Write(TProtocol oprot) {
    ...
    try
    {
      TStruct struc = new TStruct("TargetedAnalysis");
  ...
  public override string ToString() {
    StringBuilder __sb = new StringBuilder("TargetedAnalysis(");
    bool __first = true;
    if (TcChannelID != null && __isset.tcChannelID) {
