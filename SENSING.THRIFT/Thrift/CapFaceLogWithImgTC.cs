...
[Serializable]
#endif
public partial class CapFaceLogWithImgTC : TBase
{
  private string _ID;
  ...
  public void Write(TProtocol oprot) {
    ...
    try
    {
      TStruct struc = new TStruct("CapFaceLogWithImgTC");
  ...
  public override string ToString() {
    StringBuilder __sb = new StringBuilder("CapFaceLogWithImgTC(");
    bool __first = true;
    if (ID != null && __isset.ID) {
