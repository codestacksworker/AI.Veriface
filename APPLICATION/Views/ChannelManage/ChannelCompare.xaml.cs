...
using static FaceSysByMvvm.ViewModels.ChannelManage.ChannelCompareViewModel;
...
namespace FaceSysByMvvm.Views.ChannelManager
{
    ...
    public partial class ChannelCompare : Window
    {
        ...
        public void SetIdentifyResults(PublishResult _IdentifyResults)
        {
            cCViewModel.Image = _IdentifyResults.SanpImage;
            ...
            {
                CodeStacksWindow.MessageBox.Invoke(true, false, 2, "获取抓拍实时帧失败!");
            }
        }
        ...
        private void ListFaceObject_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            cCViewModel.CapInfoList[2].Value = BasicDataEntry.GetTemplateType(faceObj[0].NType);
            //
        ...
        private void ListFaceObject_SizeChanged_1(object sender, SizeChangedEventArgs e)
        {
            ...
            {
                Logger<OperaExcel>.Log.Error("ListFaceObject_SizeChanged_1", ex);
            }
        }
    }
}
